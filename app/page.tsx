...
export default function Home() {
  return <main className="site-shell">
    ...
    <footer id="contact"><div className="brand"><strong>DSBM</strong><span>Darkies Sampling Beat Mafia</span><small>© 2024 DSBM. All rights reserved.</small></div><div className="footer-social"><p>Stay connected</p><span><a href="http://www.youtube.com/@turndaback" aria-label="YouTube">◉</a>　<a href="https://www.instagram.com/turndaback?igsh=amdvMWlheHgxMnd0&utm_source=qr" aria-label="Instagram">◎</a>　◌　𝕏</span></div><div className="footer-contact"><p>Contact / inquiry</p><a href="mailto:hello@dsbmusic.com">✉ &nbsp; dsbm.mafia@gmail.com</a></div><div className="advisory">Parental<br />Advisory</div></footer>
  </main>;
}
